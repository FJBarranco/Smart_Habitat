...
*/
	...
	else  // Wet off 
	{
		...
		tft.print(" ");
			...
			// else (LightValue = 1) // Change the value of maximum Lighting exposure depending on required parameters (default = 1)
			//{
			...
			if (humidity <= 60) // Change the value of minimum humidity depending on required parameters (default <= 80%)
			{
			...
			if (humidity >= 70) // Change the value of maximum humidity depending on required parameters (default >= 90%)
			{
			...
			if (temperature >= 30) // Change the value of maximum temperature (C) depending on required parameters (default >= 38c)
			{
			...
			if (temperature <= 28)   // Change the value of minimum temperature (C) depending on required parameters (default <= 35c)
			{
			...
			if (temperature <= 24) // Change the value of minimum temperature (C) depending on required parameters (default <= 28c)
			{
			...
			if (temperature >= 27)   // Change the value of maximum temperature (C) depending on required parameters (default >= 30c)
			{
			...
			if ((Soiltemp.getTempCByIndex(0)) <= 24) // Change the value of maximum Soil Temp depending on required parameters (default <= 33c )
			{
			...
			if ((Soiltemp.getTempCByIndex(0)) >= 27) // Change the value of maximum Soil Temp depending on required parameters (default >= 35c )
			{
...

		{
				...
				delay(90000); //Delay 1 min 30 sec
				tft.fillRect(20, 55, 540, 450, BLACK); //Reset Screen
