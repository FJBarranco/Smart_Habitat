...

{
	...
	//======== Light Intensity ================================= 
	int val = digitalRead(LightInt);
	Serial.print("Light Intensity: ");
	Serial.println(val); // Display Value on Debugger
	...
	if (LightInt <= 700) // Change the value of maximum Lighting exposure depending on required parameters (default = )
	{
