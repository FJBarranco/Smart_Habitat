...
//int SensorFailAlarm  = 44; //  Alarm For Actuator Fail Relay 1 (Planned For v1.5)*****


//===================== Sensor Fixed ot Fail Overide Button  =============================

//const int buttonPin = 37; // Digital Pin 37
//int buttonState = 0; // Button State Variable (On or Off)


//===================== Relay Control (System controller) ============================= (NEW! v1.4)


int TwelveVAlarm = 27; // Activates Alarm when voltage is under 12V Relay 1
int BackUpPower = 29; // Switches To Back Up Power When under 5V Relay 2
