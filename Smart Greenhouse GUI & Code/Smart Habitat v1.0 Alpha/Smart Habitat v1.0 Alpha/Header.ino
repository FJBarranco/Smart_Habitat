...
int pinDHT11 = 22; // Temp. & Humid. Sensor pin 53
#define ONE_WIRE_BUS 24 // Soil Temp Sensor pin 51
int Soilmoistsensor = A15; // Soil Moisture Analog A14
int LightInt = 49; // Light Intensity 
int val = 0;
//=====================Relay Control=============================
